    ...
    class GrabImage
    {
            ...
            if (null != obj)
            {
                ...
                while (!g_bExit)
                {
                    ...
                    else
                    {
                        ...
                        if (CErrorCode.MV_FG_SUCCESS == nRet)
                        {
                            Console.WriteLine("FrameNumber: " + stFrameInfo.nFrameID.ToString() + ", Width: " + stFrameInfo.nWidth.ToString() 
                                + ", Height: " + stFrameInfo.nHeight.ToString() + ", nFilledSize: " + stFrameInfo.nFilledSizeEx.ToString());
                        }
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                UInt64 nPayloadSize = 0;
                nRet = cStream.GetPayloadSizeEx(ref nPayloadSize);
                if (CErrorCode.MV_FG_SUCCESS != nRet)
                {
                ...
                for (uint i = 0; i < BUFFER_NUMBER; i++)
                {
                    ...
                    ptrBuffers[i] = CSystem.MV_MEM_AllocEx(nPayloadSize, 64);
                    ...
                    nRet = cStream.AnnounceBufferEx(ptrBuffers[i], nPayloadSize, IntPtr.Zero, out cBuffers[i]);
                    if (CErrorCode.MV_FG_SUCCESS != nRet)
                    {
